...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "ClinicSaaS — Gestão completa para clínicas" },
      { name: "description", content: "Sistema SaaS multi-clínica: pacientes, prontuário, agenda, financeiro com PIX e relatórios em PDF." },
    ],
